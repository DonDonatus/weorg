...
export default function FellowshipHero(): JSX.Element {
    return (
        <section 
        ...
        >
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 text-center">
                ...
                <h1 
                    ...
                    data-aos-duration="1000"
                >
                    <span className="block mb-2">AI Innovation</span>
                ...
                <p 
                    ...
                    data-aos-duration="1000"
                >
                    Join Africa's premier AI fellowship program. Work with cutting-edge technology, 
                    solve real-world problems, and shape the future of AI innovation across the continent.
                </p>
                ...
                >
                    ...
                    <div className="text-center bg-slate-900/40 rounded-xl p-4 border border-slate-700/50">
                        <div className="text-2xl sm:text-3xl font-bold text-emerald-400 mb-2">50+</div>
                ...
                >
                    <div className="flex items-center space-x-2 text-slate-300">
                        <Clock className="w-4 sm:w-5 h-4 sm:h-5 text-cyan-400" aria-hidden="true" />
                        <span className="font-medium text-sm sm:text-base">Application Deadline:</span>
                        <span className="text-cyan-400 font-bold text-sm sm:text-base">March 31, 2025</span>
                    </div>
                </div>
            </div>
        </section>
