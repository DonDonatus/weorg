                ...
                <div key={item.label} className="relative">
                  {item.type === 'dropdown' ? (
                        ...
                        <div 
                          ...
                          {item.children?.map((child) => (
                            <button
                              ...
                              className="w-full text-left px-4 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 transition-colors cursor-pointer font-serif"
                            >
                              {child.label}
                            </button>
                          ))}
                    ...
                    <button
                      ...
                      className="px-3 py-2 text-gray-600 hover:text-gray-900 transition-colors font-serif font-medium tracking-wide cursor-pointer"
                    >
                      {item.label}
                    </button>
                  )}
