      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-12 lg:py-20 z-10">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          ...
          <div
            ...
            } space-y-6 sm:space-y-8 lg:space-y-12 text-center lg:text-left relative z-20 order-1`}
            data-aos="fade-right"
            data-aos-delay="200"
          >
            ...
            <div className="mt-8 sm:mt-4 md:mt-6 lg:mt-8 space-y-6 sm:space-y-4 md:space-y-6 lg:space-y-8">
              ...
              <div
                className="space-y-2 sm:space-y-3 md:space-y-4 lg:space-y-5 max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-2xl mx-auto lg:mx-0"
                data-aos="fade-up"
                data-aos-delay="600"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 lg:gap-6 justify-center lg:justify-start" data-aos="fade-up" data-aos-delay="800">
              ...
              <Link href="/learnmore" className="w-full sm:w-auto">
                <button className="btn-white w-full transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-white/25 group text-sm sm:text-base md:text-lg">
                  <span className="flex items-center justify-center">Explore Technology</span>
                </button>
              </Link>
            </div>
                  ...
                  {stats.map((stat, index) => (
                    ...
                    >
                      <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-bold mb-1 sm:mb-2">
                        <span className={`${stat.color} group-hover:drop-shadow-lg transition-all duration-300`}>{stat.value}</span>
                      </div>
                      <div className="text-lg sm:text-xl md:text-2xl text-slate-400 font-medium mb-0.5 sm:mb-1">{stat.icon}</div>
          ...
          <div
            className={`relative ${isVisible ? "animate-slide-up" : "opacity-0"} w-full max-w-sm sm:max-w-md mx-auto lg:max-w-none lg:mx-0 order-2 lg:order-last`}
            data-aos="fade-left"
            data-aos-delay="400"
          >
              ...
              <div className="relative z-10">
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 lg:space-x-5 mt-1 sm:mt-2 md:mt-3 lg:mt-6 mb-3 sm:mb-4 md:mb-5 lg:mb-8">
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    ...
                    <p className="text-cyan-300 text-xs sm:text-sm md:text-base leading-tight">Real-time system monitoring</p>
                  </div>
                </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 lg:space-x-5 min-w-0 flex-1">
                            <div
                              className={`w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center transition-all duration-500 flex-shrink-0 ${
                                isActive ? "bg-gradient-to-r from-cyan-500 to-blue-600 shadow-xl sm:shadow-2xl shadow-cyan-500/30" : "bg-slate-700 hover:bg-slate-600"
                              }`}
                            >
                              <IconComponent
                                className={`w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 ${isActive ? "text-white" : "text-slate-400"}`}
                              />
                            </div>
                            <div className="min-w-0 flex-1">
                              <span className={`font-semibold text-xs sm:text-sm md:text-base block truncate ${isActive ? "text-white" : "text-slate-300"}`}>
                                {metric.label}
                              </span>
                              <p className="text-xs sm:text-sm text-slate-400 mt-0.5 sm:mt-1 hidden sm:block truncate">{metric.description}</p>
                            </div>
                          </div>
                          <span className={`font-bold text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl ${metric.color} ${isActive ? "animate-pulse" : ""} flex-shrink-0 ml-1.5 sm:ml-2`}>
                            {metric.value}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-1.5 sm:space-x-2 md:space-x-3 lg:space-x-4">
                        <div className="flex space-x-0.5 sm:space-x-1 md:space-x-1.5">
                          ...
                          <div
                            className="w-1.5 h-1.5 sm:w-2 sm:h-2 md:w-2.5 md:h-2.5 bg-green-400 rounded-full animate-pulse shadow-lg shadow-green-400/50"
                        ...
                        <span className="text-xs sm:text-sm md:text-base text-green-400 font-medium truncate">All Systems Operational</span>
                      </div>
                      <div className="flex items-center space-x-1 sm:space-x-1.5 md:space-x-2 text-cyan-400">
                        ...
                        <span className="text-xs sm:text-sm md:text-base font-medium">Live Feed</span>
                      </div>
                    </div>
                  </div>
                </div>
