...
export default function ScheduleDemo() {
  ...
  // Explicitly type the event as a union of input and textarea events
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-[#DCDAF7]/30 to-[#DCDAF7]/20 rounded-full px-6 py-3 border border-[#DCDAF7]/50 mb-8">
              ...
              <span className="text-[#0F0640] font-semibold text-sm tracking-wide">
                Schedule Your Demo
              </span>
            </div>
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-12">
              Experience a personalized demonstration of how our AI agents can transform your operations, reduce wait times, and enhance service delivery.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[
              ...
              return (
                <div
                  key={index}
                  className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-[#DCDAF7]/30 text-center"
                >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div
                  key={index}
                  className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-[#DCDAF7]/30"
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-[#1E06BE] to-[#5206F1] rounded-xl flex items-center justify-center mx-auto mb-4">
                    <IconComponent className="w-6 h-6 text-white" />
                  </div>
                  <div className="text-3xl font-bold text-[#1E06BE] mb-2">
                    {item.stat}
                  </div>
