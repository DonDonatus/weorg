...
import { Users, Building2, GraduationCap, Globe, ArrowRight, CheckCircle, Handshake, Target, Heart, Zap } from 'lucide-react';
    ...
    const partnerTypes = [
        {
            icon: Building2,
            title: "Government",
            description: "Pilots, workflow transformation",
        ...
        },
        {
            icon: GraduationCap,
            title: "Academia",
            description: "Co-research, fellow pipelines",
        ...
        },
        {
            ...
            description: "Fellowship & infrastructure funding",
                ...
                <section className="relative pt-12 sm:pt-16 md:pt-20 lg:pt-24 pb-12 sm:pb-16 md:pb-20 bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 overflow-hidden" aria-labelledby="hero-heading">
                    ...
                    <div id="main-content" className="relative max-w-5xl mx-auto px-3 sm:px-4 md:px-6 text-center">
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-200 max-w-4xl mx-auto leading-relaxed mb-4 sm:mb-6 md:mb-8 px-2 sm:px-4">
                            We collaborate with ministries, universities, startups, and global tech leaders to drive AI innovation across Africa.
                        </p>
                        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
                            <Link
                                href="/contact"
                                className="btn-primary group text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto min-h-[44px] shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-950"
                                aria-label="Talk to our partnerships team"
                            >
                            ...
                            <Link
                                href="/demo"
                                className="btn-white group text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto min-h-[44px] shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-950"
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-12 sm:mb-16" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            ...
                            <p className="text-lg text-slate-300 max-w-2xl mx-auto">
                                We collaborate across key sectors to drive AI innovation and create lasting impact
                            </p>
                        </div>
                        ...
                        <div className="max-w-4xl mx-auto">
                            <div className="grid md:grid-cols-2 gap-6 sm:gap-6 lg:gap-8">
                                {partnerTypes.map((partner, index) => {
                                    ...
                                    return (
                                        <div key={partner.title} className="group relative" data-aos="fade-up" data-aos-delay={400 + (index * 200)} data-aos-duration="1000">
                                            ...
                                            <div className={`relative bg-slate-800/80 backdrop-blur-xl rounded-2xl p-4 sm:p-5 md:p-6 border border-slate-700/50 ${borderGradients[index]} transition-all duration-500`}>
                                                <div className="flex items-center mb-3 sm:mb-4">
                                                    <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center rounded-xl bg-gradient-to-br ${iconColors[index]}`}>
                                                        <partner.icon className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-white" />
                                                    </div>
                                                    <h3 className="text-lg sm:text-xl font-semibold text-white ml-3">{partner.title}</h3>
                                                </div>
                                                <p className="text-slate-300 leading-relaxed text-sm sm:text-base mb-3 sm:mb-4">
                                                    {partner.description}
                                                </p>
                                                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-slate-700/50 text-slate-200 border border-slate-600/50">
                                                    {partner.highlight}
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="max-w-6xl mx-auto px-4 sm:px-6">
                        <div className="text-center mb-8 sm:mb-10" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            ...
                            <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                                We&apos;re proud to collaborate with leading organizations across sectors
                            </p>
                        </div>
                            ...
                            <div className="flex flex-col justify-center">
                                <div className="flex flex-wrap justify-center gap-3 sm:gap-5 md:justify-around" role="list" aria-label="Partner company logos">
                                    ...
                                    <div className="pt-1 text-gray-400 dark:text-gray-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="90" height="24" className="sm:w-[108px] sm:h-[29px]" fill="none" viewBox="0 0 108 29">
                                            <g>
                                    ...
                                    <div className="pt-2 text-gray-400 dark:text-gray-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="110" height="20" className="sm:w-[136px] sm:h-[24px]" viewBox="0 0 351 61">
                                            <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                            ...
                            <div className="lg:pt-4 lg:pr-8" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                                <div className="lg:max-w-lg">
                                    ...
                                    <dl className="mt-8 sm:mt-10 max-w-xl space-y-6 sm:space-y-8 text-sm sm:text-base/7 text-slate-400 lg:max-w-none">
                                        <div className="relative pl-8 sm:pl-9" data-aos="fade-up" data-aos-delay="400" data-aos-duration="800">
                                            <dt className="inline font-semibold text-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="absolute top-1 left-1 size-5 sm:size-6 text-green-400">
                                            ...
                                            <dd className="inline"> Solutions built specifically for African contexts and challenges, ensuring relevance and impact.</dd>
                                        </div>
                                        <div className="relative pl-8 sm:pl-9" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800">
                                            <dt className="inline font-semibold text-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="absolute top-1 left-1 size-5 sm:size-6 text-green-400">
                                                    <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0 1 12 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 0 1 3.498 1.307 4.491 4.491 0 0 1 1.307 3.497A4.49 4.49 0 0 1 21.75 12a4.49 4.49 0 0 1-1.549 3.397 4.491 4.491 0 0 1-1.307 3.497 4.491 4.491 0 0 1-3.497 1.307A4.49 4.49 0 0 1 12 21.75a4.49 4.49 0 0 1-3.397-1.549 4.49 4.49 0 0 1-3.498-1.306 4.491 4.491 0 0 1-1.307-3.498A4.49 4.49 0 0 1 2.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 0 1 1.307-3.497 4.49 4.49 0 0 1 3.497-1.307Zm7.007 6.387a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clipRule="evenodd" />
                                                </svg>
                                            ...
                                            <dd className="inline"> Practical AI solutions that deliver measurable impact and drive tangible business outcomes.</dd>
                                        </div>
                                        <div className="relative pl-8 sm:pl-9" data-aos="fade-up" data-aos-delay="800" data-aos-duration="800">
                                            <dt className="inline font-semibold text-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="absolute top-1 left-1 size-5 sm:size-6 text-green-400">
                                                    <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0 1 12 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 0 1 3.498 1.307 4.491 4.491 0 0 1 1.307 3.497A4.49 4.49 0 0 1 21.75 12a4.49 4.49 0 0 1-1.549 3.397 4.491 4.491 0 0 1-1.307 3.497 4.491 4.491 0 0 1-3.497 1.307A4.49 4.49 0 0 1 12 21.75a4.49 4.49 0 0 1-3.397-1.549 4.49 4.49 0 0 1-3.498-1.306 4.491 4.491 0 0 1-1.307-3.498A4.49 4.49 0 0 1 2.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 0 1 1.307-3.497 4.49 4.49 0 0 1 3.497-1.307Zm7.007 6.387a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clipRule="evenodd" />
                                                </svg>
                                            ...
                                            <dd className="inline"> Clear communication and transparent processes throughout project delivery, ensuring trust and accountability.</dd>
                                        </div>
                                        <div className="relative pl-8 sm:pl-9" data-aos="fade-up" data-aos-delay="1000" data-aos-duration="800">
                                            <dt className="inline font-semibold text-white">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="absolute top-1 left-1 size-5 sm:size-6 text-green-400">
                                                    <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0 1 12 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 0 1 3.498 1.307 4.491 4.491 0 0 1 1.307 3.497A4.49 4.49 0 0 1 21.75 12a4.49 4.49 0 0 1-1.549 3.397 4.491 4.491 0 0 1-1.307 3.497 4.491 4.491 0 0 1-3.497 1.307A4.49 4.49 0 0 1 12 21.75a4.49 4.49 0 0 1-3.397-1.549 4.49 4.49 0 0 1-3.498-1.306 4.491 4.491 0 0 1-1.307-3.498A4.49 4.49 0 0 1 2.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 0 1 1.307-3.497 4.49 4.49 0 0 1 3.497-1.307Zm7.007 6.387a.75.75 0 1 0-1.22-.872l-3.236 4.53L9.53 12.22a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.75-5.25Z" clipRule="evenodd" />
                                                </svg>
                                            ...
                                            <dd className="inline"> Access to skilled AI professionals and researchers, providing sustainable talent solutions.</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
                ...
                <section className="relative py-20 bg-black" aria-labelledby="cta-heading">
                    ...
                    <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                        ...
                        <p className="text-lg md:text-xl text-slate-300 mb-8">
                            Let&apos;s explore how we can work together to drive AI innovation and create lasting impact across Africa.
                        </p>
