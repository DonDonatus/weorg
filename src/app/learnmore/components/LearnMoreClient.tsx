        ...
        <div className="min-h-screen bg-white font-sans antialiased overflow-x-hidden">
            ...
            <header className={`fixed top-0 w-full z-50 py-4 px-6 sm:px-8 transition-all duration-300 ${scrollY > 50 ? 'bg-white/80 backdrop-blur-md border-b border-gray-100' : 'bg-transparent'
                ...
                <div className="flex justify-between items-center max-w-7xl mx-auto">
                    ...
                    <Image src="/logo_full_b.png" alt="WE Logo" width={120} height={32} className="h-8 w-auto" />
                </div>
            </header>
            ...
            <section id="contact" className="py-20 sm:py-32 bg-gradient-to-br from-gray-900 via-gray-900 to-blue-900 text-white px-6 sm:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        <Link href="/contact" className="group bg-white text-gray-900 px-8 py-4 rounded-xl hover:bg-gray-100 transition-all duration-300 hover:shadow-lg flex items-center justify-center gap-3 font-semibold">
                            <span>Get started</span>
                            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link href="/contact" className="border-2 border-gray-300 text-white px-8 py-4 rounded-xl hover:bg-white hover:text-gray-900 transition-all duration-300 font-semibold">
                            Contact sales
                        </Link>
                    </div>
                </div>
            ...
            <footer className="py-16 bg-gray-950 px-6 sm:px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <Image src="/logo_full_b.png" alt="WE Logo" width={120} height={32} className="h-8 w-auto mx-auto mb-6 invert opacity-90" />
